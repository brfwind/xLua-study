...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp0(int p0, out int p1, out bool p2, out string p3, out int p4)
		{
		...
		public void __Gen_Delegate_Imp1(string p0, int[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new CustomCall3(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(CustomCall5))
			{
			    return new CustomCall5(__Gen_Delegate_Imp1);
			}
